...
export type ImportResolver = LiteralUnion<'node' | 'typescript' | 'webpack', string> | {
...
export type CustomESTreeNode<Type extends string, T extends object = {}> = Omit<TSESTree.BaseNode, 'type'> & {
    type: Type;
} & T;
