    ...
    create(context) {
        ...
        const checkExportPresence = (node) => {
            ...
            if (exportCount.size === 0) {
                context.report({
                    node: (_a = node.body[0]) !== null && _a !== void 0 ? _a : node,
                    messageId: 'notFound',
                });
            }
        ...
        const updateExportUsage = (node) => {
            ...
            const exports = (_a = exportList.get(filename)) !== null && _a !== void 0 ? _a : new Map();
            ...
            const exportAll = exports.get(AST_NODE_TYPES.ExportAllDeclaration);
            const namespaceImports = (_b = exports.get(AST_NODE_TYPES.ImportNamespaceSpecifier)) !== null && _b !== void 0 ? _b : { whereUsed: new Set() };
        ...
        const updateImportUsage = (node) => {
            ...
            const oldImportPaths = (_a = importList.get(filename)) !== null && _a !== void 0 ? _a : new Map();
            ...
            for (const value of newExportAll) {
                if (!oldExportAll.has(value)) {
                    const imports = (_b = oldImportPaths.get(value)) !== null && _b !== void 0 ? _b : new Set();
